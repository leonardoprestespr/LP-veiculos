...
from registros.funcionarios.funcoes import cadastrar
from validacoes_autenticacoes.validacoes import (
    validar_idade, validar_telefone, validar_email, validar_documento)

# função que vai ser chamada no "main.py" para solicitar os dados dos funcionarios
